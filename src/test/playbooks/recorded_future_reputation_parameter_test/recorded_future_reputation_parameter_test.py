...
def IP_Reputation_Parameters(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
Summary level {7}"""
    ...
    phantom.prompt2(container=container, user=user, message=message, respond_in_mins=30, name="IP_Reputation_Parameters", parameters=parameters, response_types=response_types)

    return

def Domain_Reputation_Parameters(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
Summary level {7}"""
    ...
    phantom.prompt2(container=container, user=user, message=message, respond_in_mins=30, name="Domain_Reputation_Parameters", parameters=parameters, response_types=response_types)

    return

def File_Reputation_Parameters(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
Summary level {7}"""
    ...
    phantom.prompt2(container=container, user=user, message=message, respond_in_mins=30, name="File_Reputation_Parameters", parameters=parameters, response_types=response_types)

    return

def Vulnerability_Reputation_Parameters(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
Summary level {7}"""
    ...
    phantom.prompt2(container=container, user=user, message=message, respond_in_mins=30, name="Vulnerability_Reputation_Parameters", parameters=parameters, response_types=response_types)

    return

def URL_Reputation_Parameters(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
Summary level {7}"""
    ...
    phantom.prompt2(container=container, user=user, message=message, respond_in_mins=30, name="URL_Reputation_Parameters", parameters=parameters, response_types=response_types)

    return

def ip_reputation_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("ip reputation", parameters=parameters, assets=['recorded-future '], callback=decision_1, name="ip_reputation_4")

    return

def domain_reputation_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("domain reputation", parameters=parameters, assets=['recorded-future '], callback=decision_2, name="domain_reputation_3")

    return

def file_reputation_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("file reputation", parameters=parameters, assets=['recorded-future '], callback=decision_3, name="file_reputation_4")

    return

def vulnerability_reputation_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("vulnerability reputation", parameters=parameters, assets=['recorded-future '], callback=decision_4, name="vulnerability_reputation_3")
...
def url_reputation_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("url reputation", parameters=parameters, assets=['recorded-future '], callback=decision_5, name="url_reputation_4")
...
def decision_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    if matched_artifacts_1 or matched_results_1:
        IP_Reputation_Parameters(action=action, success=success, container=container, results=results, handle=handle)
        return
...
def decision_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    # call connected blocks if condition 1 matched
    if matched_artifacts_1 or matched_results_1:
        Domain_Reputation_Parameters(action=action, success=success, container=container, results=results, handle=handle)
        return
...
def decision_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    # call connected blocks if condition 1 matched
    if matched_artifacts_1 or matched_results_1:
        File_Reputation_Parameters(action=action, success=success, container=container, results=results, handle=handle)
        return
...
def decision_4(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    # call connected blocks if condition 1 matched
    if matched_artifacts_1 or matched_results_1:
        Vulnerability_Reputation_Parameters(action=action, success=success, container=container, results=results, handle=handle)
        return
...
def decision_5(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    # call connected blocks if condition 1 matched
    if matched_artifacts_1 or matched_results_1:
        URL_Reputation_Parameters(action=action, success=success, container=container, results=results, handle=handle)
        return
