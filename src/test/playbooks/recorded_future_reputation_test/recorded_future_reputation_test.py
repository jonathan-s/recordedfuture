...
def vulnerability_reputation_1(
    action=None,
    success=None,
    container=None,
    results=None,
    ...
    phantom.act(
        ...
        parameters=parameters,
        assets=["recorded-future"],
        name="vulnerability_reputation_1",
    )

    return


def url_reputation_1(
    action=None,
    success=None,
    container=None,
    results=None,
