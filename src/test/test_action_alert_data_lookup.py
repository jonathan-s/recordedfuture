...
class RfAlertDataLookupTests(RfTests):
    ...
    def test_ok_single_alert_data_lookup(self):
        ...
        self.assertIsInstance(
            ares["data"][0]["result_data"][0]["summary"]["returned_number_of_alerts"],
            int,
        )
        self.assertIsInstance(
            ares["data"][0]["result_data"][0]["summary"]["total_number_of_alerts"], int
        )
        self.assertIsInstance(
    ...
    def test_neg_alert_data_lookup_no_match(self):
        ...
        self.assertEqual(
            ares["data"][0]["result_data"][0]["summary"]["total_number_of_alerts"], 0
        )
