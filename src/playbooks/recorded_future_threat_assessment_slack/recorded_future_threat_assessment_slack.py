...
def initial_event_update(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
def close_event(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
def threat_assessment_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('threat_assessment_2() called')

    # collect data for 'threat_assessment_2' call
    container_data = phantom.collect2(container=container, datapath=['artifact:*.cef.destinationDnsDomain', 'artifact:*.cef.fileHash', 'artifact:*.cef.requestURL', 'artifact:*.cef.destinationAddress', 'artifact:*.id'])
    ...
    phantom.act("threat assessment", parameters=parameters, assets=['recorded-future '], callback=decision_1, name="threat_assessment_2")
...
def send_message_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.act("send message", parameters=parameters, assets=['slack'], callback=promote_to_case, name="send_message_2")
...
def decision_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    # call connected blocks for 'else' condition 2
    increase_severity(action=action, success=success, container=container, results=results, handle=handle)

    return

def increase_severity(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
...
def promote_to_case(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.pin(container=container, data="", message="promoted to case", pin_type="card", pin_style="red", name=None)
