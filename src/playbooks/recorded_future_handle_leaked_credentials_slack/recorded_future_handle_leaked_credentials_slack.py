...
def get_alerts(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act("alert data lookup", parameters=parameters, name="get_alerts", assets=["recorded-future"], callback=format_slack_message)
...
def send_slack_message(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act("send message", parameters=parameters, name="send_slack_message", assets=["slack"])
