...
def lookup_ip_intelligence(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act("ip intelligence", parameters=parameters, name="lookup_ip_intelligence", assets=["recorded-future"], callback=inspect_risk)

    return


def inspect_risk(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
...
def send_slack_message(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act("send message", parameters=parameters, name="send_slack_message", assets=["slack"], callback=add_bad_ip_to_list)

    return


def add_bad_ip_to_list(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
