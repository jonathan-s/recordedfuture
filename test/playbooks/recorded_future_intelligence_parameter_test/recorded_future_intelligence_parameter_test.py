...
def IP_Intelligence_Parameters(
    action=None,
    success=None,
    container=None,
    results=None,
...
{4}"""
    ...
    phantom.prompt2(
        ...
        message=message,
        respond_in_mins=30,
        name="IP_Intelligence_Parameters",
...
def Domain_Intelligence_Parameters(
    action=None,
    success=None,
    container=None,
    results=None,
...
{4}"""
    ...
    phantom.prompt2(
        ...
        message=message,
        respond_in_mins=30,
        name="Domain_Intelligence_Parameters",
        parameters=parameters,
        response_types=response_types,
    )
...
def File_Intelligence_Parameters(
    action=None,
    success=None,
    container=None,
    results=None,
...
{4}"""
    ...
    phantom.prompt2(
        ...
        message=message,
        respond_in_mins=30,
        name="File_Intelligence_Parameters",
        parameters=parameters,
        response_types=response_types,
    )
...
def Vulnerability_Intelligence_Parameters(
    action=None,
    success=None,
    container=None,
    results=None,
...
{4}"""
    ...
    phantom.prompt2(
        ...
        message=message,
        respond_in_mins=30,
        name="Vulnerability_Intelligence_Parameters",
        parameters=parameters,
        response_types=response_types,
    )
...
def URL_Intelligence_Parameters(
    action=None,
    success=None,
    container=None,
    results=None,
...
{4}"""
    ...
    phantom.prompt2(
        ...
        message=message,
        respond_in_mins=30,
        name="URL_Intelligence_Parameters",
        parameters=parameters,
        response_types=response_types,
    )
...
def decision_2(
    ...
    # call connected blocks if condition 1 matched
    if matched_artifacts_1 or matched_results_1:
        Domain_Intelligence_Parameters(
            action=action,
            success=success,
            container=container,
            results=results,
...
def decision_4(
    ...
    # call connected blocks if condition 1 matched
    if matched_artifacts_1 or matched_results_1:
        Vulnerability_Intelligence_Parameters(
            action=action,
            success=success,
            container=container,
            results=results,
...
def domain_intelligence_1(
    ...
    phantom.act(
        ...
        assets=["recorded-future "],
        callback=decision_2,
        name="domain_intelligence_1",
    )

    return


def file_intelligence_1(
    action=None,
    success=None,
    container=None,
    results=None,
    ...
    phantom.act(
        ...
        assets=["recorded-future "],
        callback=decision_3,
        name="file_intelligence_1",
    )

    return


def vulnerability_intelligence_1(
    action=None,
    success=None,
    container=None,
    results=None,
    ...
    phantom.act(
        ...
        assets=["recorded-future "],
        callback=decision_4,
        name="vulnerability_intelligence_1",
    )

    return


def url_intelligence_1(
    action=None,
    success=None,
    container=None,
    results=None,
