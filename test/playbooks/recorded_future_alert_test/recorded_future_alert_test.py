...
def alert_data_lookup_1(
    ...
    container_data = phantom.collect2(
        container=container,
        datapath=["artifact:*.cef.cs1", "artifact:*.cef.cs2", "artifact:*.id"],
    )
...
def format_2(
    ...
    phantom.format(
        container=container, template=template, parameters=parameters, name="format_2"
    )
