...
def decision_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    if matched_artifacts_2 or matched_results_2:
        alert_rule_id_lookup_2(action=action, success=success, container=container, results=results, handle=handle)
        return
...
def alert_rule_id_lookup_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    phantom.debug('alert_rule_id_lookup_2() called')

    # collect data for 'alert_rule_id_lookup_2' call
    container_data = phantom.collect2(container=container, datapath=['artifact:*.cef.cs1', 'artifact:*.id'])

    parameters = []
    
    # build parameters list for 'alert_rule_id_lookup_2' call
    for container_item in container_data:
        if container_item[0]:
            parameters.append({
    ...
    phantom.act("alert rule id lookup", parameters=parameters, assets=['recordedfuture'], callback=format_2, name="alert_rule_id_lookup_2")
...
def format_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    # parameter list for template variable replacement
    parameters = [
        "alert_rule_id_lookup_2:action_result.message",
    ]
...
def add_comment_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    phantom.comment(container=container, comment=formatted_data_1)
    alert_data_lookup_2(container=container)
...
def format_3(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None):
    ...
    # parameter list for template variable replacement
    parameters = [
        "alert_data_lookup_2:action_result.message",
    ]
